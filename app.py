import daily_spending_tracker, view
from typing import Union

# def handle_load(args: tuple) -> Union[todo_list.monthspending, None]:
...
#         filename = args[0]
#     try:
#         monthspending = todo_list.load_list_from_file(filename)
...
def handle_add(monthspending =
               daily_spending_tracker.MonthSpending) -> daily_spending_tracker.MonthSpending:
...
def handle_summary(monthspending =
                   daily_spending_tracker.MonthSpending) -> None:
...
def main():
    ...
    while command != view.ViewOptions.EXIT:
        ...
        elif monthspending is None and command != view.ViewOptions.UNKNOWN and command != view.ViewOptions.EXIT:
